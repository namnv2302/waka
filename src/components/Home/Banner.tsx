...
function Banner() {
  ...
  return (
    <div className="relative">
      <div className="header bg-gradient-overlay fixed z-10 top-0 left-0 bg-[rgba(18,18,20,.8)] flex justify-between items-center w-full h-[68px] px-[60px] ">
        <div className="flex items-center gap-[48px]">
          <Image src={images.LogoImage} alt="" className="h-[32px] w-[108px" />
          <ul className="flex items-center gap-[24px]">
            {navigation.map((item, index) => {
              ...
              return (
                <li
                  className="text-[16px] font-medium text-second leading-[20px] cursor-pointer hover:text-primary"
                  key={index}
                >
        ...
        <div className="flex items-center gap-[24px]">
          ...
          />
          <div className="flex items-center h-[32px] w-[96px] rounded-2xl border border-comic-500 gap-[3px] py-[4px] px-[10px] bg-[rgba(255,204,0,.16)] cursor-pointer">
            <Image
          ...
          <div className="flex items-center gap-[8px] cursor-pointer">
            <div className="flex items-center justify-center w-[42px] h-[42px] bg-gradient-to-r from-[#FB3A1A] to-[#EBB004] rounded-full p-[1px]">
